-- Complete Fix for All Remaining Test Failures (v3)
-- Run this in your Supabase SQL editor
-- This version handles different schema variations
...
BEGIN
    ...
    IF EXISTS (
        SELECT 1 FROM information_schema.columns
        WHERE table_name = 'debates' AND column_name = 'tweet_id'
    ) THEN
        -- Insert with tweet_id
        INSERT INTO debates (
            id,
            competitor_agent_id,
            tweet_id,
