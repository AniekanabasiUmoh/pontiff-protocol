-- =====================================================
-- FINAL MIGRATION FOR MODULES 9-12
-- Run this ENTIRE script in Supabase SQL Editor
-- =====================================================

-- Step 1: Drop and recreate world_events with correct schema
...
CREATE INDEX "world_events_type_idx" ON "world_events"("eventType");
CREATE INDEX "world_events_timestamp_idx" ON "world_events"("timestamp" DESC);

-- Step 2: Module 9 - Competitor Agents
DROP TABLE IF EXISTS "competitor_agents" CASCADE;
...
CREATE INDEX "competitor_agents_threat_level_idx" ON "competitor_agents"("threat_level");
CREATE INDEX "competitor_agents_is_shadow_idx" ON "competitor_agents"("is_shadow_agent");

-- Step 3: Module 10 - Debates
...
CREATE INDEX "debates_competitor_idx" ON "debates"("competitor_agent_id");

-- Step 4: Module 10 - Debate Exchanges
DROP TABLE IF EXISTS "debate_exchanges" CASCADE;
CREATE TABLE "debate_exchanges" (
    "id" TEXT NOT NULL,
...
CREATE INDEX "debate_exchanges_debate_idx" ON "debate_exchanges"("debate_id");

-- Step 5: Module 11 - Conversions
...
CREATE INDEX "conversions_type_idx" ON "conversions"("conversion_type");
CREATE INDEX "conversions_competitor_idx" ON "conversions"("competitor_agent_id");
CREATE INDEX "conversions_verified_idx" ON "conversions"("verified");

-- Step 6: Shadow Agents (for demo/testing)
DROP TABLE IF EXISTS "shadow_agents" CASCADE;
...
-- Success message
SELECT
    'SUCCESS! Modules 9-12 schema migration complete.' AS status,
    'Tables created: competitor_agents, debates, debate_exchanges, conversions, shadow_agents, world_events' AS tables;
